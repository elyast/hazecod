 ...
 * @author fekat
 * 
 * Copied from KeywordFactoryBasedLibraryTest.java (from original
 * robotframework sources)
 */
public class DocumentedKeywordFactoryBasedLibraryTest extends MockObjectTestCase {
    private DocumentedKeywordFactoryBasedLibrary<EnhancedDocumentedKeyword> library;
    ...
    protected void setUp() throws Exception {
        ...
        library = new DocumentedKeywordFactoryBasedLibrary<EnhancedDocumentedKeyword>() {
